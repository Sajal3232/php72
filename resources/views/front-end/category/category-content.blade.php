											...
											<div class="product-tab">
												...
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{asset($categoriesproduct->product_image)}}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{asset($categoriesproduct->product_image)}}/front-end/images/p5.jpg" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
														...
														<div class="women">
															<h6><a href="single.html">{{$categoriesproduct->product_name}}</a></h6>
															<span class="size">XL / XXL / S </span>
															<p ><em class="item_price">Tk. {{$categoriesproduct->product_price}}</em></p>
